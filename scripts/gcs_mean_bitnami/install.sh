...
export PATH=$PATH:~/bitcoinbin/bitcoin-0.17.0/bin/bitcoind
export PATH=$PATH:~/bitcoinbin/bitcoin-0.17.0/bin/bitcoin-cli
export PATH=$PATH:~/builds/lightning/lightningd
export PATH=$PATH:~/builds/lightning/cli
cd /usr/bin/
sudo ln -s ~/bitcoinbin/bitcoin-0.17.0/bin/bitcoind bitcoind
sudo ln -s ~/bitcoinbin/bitcoin-0.17.0/bin/bitcoin-cli bitcoin-cli
